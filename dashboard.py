...
# ---------------------------
# НАСТРОЙКА СТРАНИЦЫ И CSS-ХАК
# ---------------------------
st.set_page_config(page_title="Аналитика Чат-Бота", page_icon="🤖", layout="wide")

# CSS-хак для вывода надписи "Фильтры" при свернутой боковой панели.
# Может не работать в будущих версиях Streamlit или других темах.
st.markdown(
    """
    <style>
    /* Селектор для кнопки "развернуть" боковую панель.*/
...
# ---------------------------
def main():
    data = load_data()  # Загрузка исходного JSON
